...
import com.algawork.algamoney.api.service.PessoaService;
...
public class PessoaResource {
	...
	public  ResponseEntity<Pessoa> criar (@Valid @RequestBody Pessoa pessoa, HttpServletResponse response){
		...
		publisher.publishEvent(new RecursonCriadoEvent(this, response, pessoaSalva.getCodigo()));
	...
	@PutMapping("/{codigo}")
	@PreAuthorize("#oauth2.hasScope('change')")
